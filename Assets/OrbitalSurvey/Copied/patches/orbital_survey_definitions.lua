...
Config:Integer(MAXR, "Small",  150000,    "Max body radius (m) for the Small category")
Config:Integer(MAXR, "Medium", 350000,    "Max body radius (m) for the Medium category")
Config:Integer(MAXR, "Large",  10000000,  "Max body radius (m) for the Large category")
Config:Integer(MAXR, "Giant",  100000000, "Max body radius (m) for the Giant category")

-- Localization keys for category display names.
Config:String(LOC, "Small",  "PartModules/OrbitalSurvey/BodyCategory/Small",  "Display name loc key for Small")
Config:String(LOC, "Medium", "PartModules/OrbitalSurvey/BodyCategory/Medium", "Display name loc key for Medium")
Config:String(LOC, "Large",  "PartModules/OrbitalSurvey/BodyCategory/Large",  "Display name loc key for Large")
Config:String(LOC, "Giant",  "PartModules/OrbitalSurvey/BodyCategory/Giant",  "Display name loc key for Giant")
...
local function altitudes(category, mapType, min, ideal, max)
    ...
    Config:Integer(ALT, prefix .. "Min",   min,   category .. " " .. mapType .. " minimum scanning altitude (m)")
    Config:Integer(ALT, prefix .. "Ideal", ideal, category .. " " .. mapType .. " ideal scanning altitude (m)")
    Config:Integer(ALT, prefix .. "Max",   max,   category .. " " .. mapType .. " maximum scanning altitude (m)")
end
