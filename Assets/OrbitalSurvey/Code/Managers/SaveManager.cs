...
using SpaceWarp2.API.SaveGameManager;
using UnityEngine;
...
namespace OrbitalSurvey.Managers
{
    public class SaveManager
    {
        ...
        {
            Logger.LogDebug("OnSave triggered.");
            ...
            foreach (var celestialData in Core.Instance.CelestialDataDictionary)
            {
                ...
                Logger.LogDebug($"{celestialData.Key} prepared for saving.");
            }
        ...
        {
            Logger.LogDebug("OnLoad triggered.");
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        public async Task LoadData()
        {
            ...
            Logger.LogInfo("Mapping data loaded.");
            ...
            {
                Logger.LogDebug($"Found {bufferedLoadData.Waypoints.Count} waypoints to load.");
                ...
                foreach (var serializedWaypoint in bufferedLoadData.Waypoints)
                {
                    ...
                    Logger.LogDebug(
                        $"Loaded waypoint '{waypointModel.Waypoint.Name}' on '{waypointModel.Waypoint.BodyName}'.");
                }

                Logger.LogInfo("Waypoint data loaded.");
            }
