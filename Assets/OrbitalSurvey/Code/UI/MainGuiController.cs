...
namespace OrbitalSurvey.UI
{
    public class MainGuiController : MonoBehaviour
    {
        ...
        public void OnEnable()
        {
            ...
            var staticBackground = AssetUtility.Instance.GetTextureAsset(AssetType.Other, "StaticBackground");
        ...
        {
            if (playSound && Settings.PlayUiSounds.Value)
            {
                KSP.Audio.KSPAudioEventManager.OnKSCBuildingClick(new Vector2());
            }
        ...
        private void BuildLegend(string body)
        {
            ...
            {
                _legendContainer.Add(new LegendKeyControl(region.Color,
                    ScienceRegionsHelper.GetRegionDisplayName(region.RegionId)));
            }
        }
