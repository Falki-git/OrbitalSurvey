...
namespace OrbitalSurvey.UI
{
    public class SceneController
    {
        ...
        private UIDocument BuildUi(VisualTreeAsset visualTree, UIDocument uiDocument, Type controllerType)
        {
            ...
            uiDocument = Window.Create(options, visualTree);
        ...
        public void ToggleUI(bool state)
        {
            ...
            GameObject.Find(OrbitalSurveyPlugin.ToolbarFlightButtonID)?.GetComponent<UIValue_WriteBool_Toggle>()
                ?.SetValue(state);
            GameObject.Find(OrbitalSurveyPlugin.ToolbarOABButtonID)?.GetComponent<UIValue_WriteBool_Toggle>()
                ?.SetValue(state);
        }
