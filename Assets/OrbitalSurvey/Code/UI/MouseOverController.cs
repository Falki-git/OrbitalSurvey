...
namespace OrbitalSurvey.UI
{
    public class MouseOverController : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            _mouseOverControl.StopMouseEventsToGameInputPropagation();
            ZoomAndPanController.Instance.RegisterControlForPanAndZooming(_mouseOverControl);
        ...
        private void OnPointerMoveEvent(PointerMoveEvent evt)
        {
            ...
            {
                _mouseOverControl.NameValue = UiUtility.GetRegionNameFromGeographicCoordinates(
                    SceneController.Instance.SelectedBody,
