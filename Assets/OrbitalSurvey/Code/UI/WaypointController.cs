...
namespace OrbitalSurvey.UI
{
    public class WaypointController : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            _mapContainer.RegisterCallback<PointerDownEvent>(evt =>
            {
        ...
        private void OnMapContainerRightClicked(PointerUpEvent evt)
        {
            ...
            {
                Logger.LogDebug("RightClick detected");
                ...
                _waypointName.value = LocalizationStrings.WAYPOINT_DEFAULT_NAME;
        ...
        private void OnAddWaypointClicked(ClickEvent _)
        {
            ...
            Logger.LogInfo($"Waypoint '{waypointModel.Waypoint.Name}' created.");
        }
        ...
        private void OnMarkerPointerUpEvent(PointerUpEvent evt, WaypointModel waypoint)
        {
            if (evt.button == 1) // Right mouse button
            {
                ...
                _waypointName.value = waypoint.Waypoint.Name;
        ...
        private void OnUpdateWaypointClicked(ClickEvent evt)
        {
            ...
            switch (_waypointToAddColor)
            {
                ...
                case WaypointColor.Blue:
                    _selectedWaypointModel.Marker.SetAsBlue();
                    ;
                    break;
                case WaypointColor.Gray:
                    _selectedWaypointModel.Marker.SetAsGray();
                    ;
                    break;
