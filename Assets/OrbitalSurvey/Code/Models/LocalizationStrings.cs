...
namespace OrbitalSurvey.Models
{
    public static class LocalizationStrings
    {
        ...
        public static readonly LocalizedString WAYPOINT_CONTEXT_MENU_TITLE_ADD =
            "OrbitalSurvey/UI/Waypoint/ContextMenuTitle/Add";

        public static readonly LocalizedString WAYPOINT_CONTEXT_MENU_TITLE_EDIT =
            "OrbitalSurvey/UI/Waypoint/ContextMenuTitle/Edit";
