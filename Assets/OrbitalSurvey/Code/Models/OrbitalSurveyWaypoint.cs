...
{
    public class OrbitalSurveyWaypoint : Redux.ApiImpls.ReduxWaypoint
    {
        ...
        {
            return new OrbitalSurveySerializedWaypoint(this.Name, this.BodyName, this.Latitude, this.Longitude,
                this.AltitudeFromRadius, this.State, this.WaypointColor);
        }
    }
}