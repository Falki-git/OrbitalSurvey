...
namespace OrbitalSurvey.Utilities
{
    public static class Utility
    {
        ...
        private static readonly string _IMPORT_PATH =
        ...
        public static List<CelestialBodyComponent> GetAllCelestialBodies() =>
            GameManager.Instance.Game?.UniverseModel?.GetAllCelestialBodies();

        public static List<string> GetAllCelestialBodyNames() =>
            GetAllCelestialBodies().Select(body => body.Name).ToList();

        public static List<VesselComponent> GetAllVessels() =>
            GameManager.Instance.Game?.UniverseModel?.GetAllVessels();
