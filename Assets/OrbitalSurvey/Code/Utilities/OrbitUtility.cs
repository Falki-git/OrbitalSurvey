...
namespace OrbitalSurvey.Utilities
{
    public static class OrbitUtility
    {
        ...
        {
            return o.referenceBody.transform.celestialFrame.ToLocalPosition(o.ReferenceFrame,
                o.referenceBody.Position.localPosition + o.GetRelativePositionAtUTZup(UT).SwapYAndZ);
        }

        public static void GetOrbitalParametersAtUT(VesselComponent vessel, double UT, out double latitude,
