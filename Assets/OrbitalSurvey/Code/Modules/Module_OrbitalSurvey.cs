...
namespace OrbitalSurvey.Modules
{
    ...
    public class Module_OrbitalSurvey : PartBehaviourModule
    {
        ...
        [SerializeField] protected Data_OrbitalSurvey _dataOrbitalSurvey;
        ...
        protected override void OnInitialize()
        {
            ...
            _actionOpenGui = new ModuleAction((Action)OnOpenMapClicked);
            _triggerExperiment = new ModuleAction((Action)OnTriggerExperiment);
            _triggerScienceReport = new ModuleAction((Action)OnCreateScienceReport);
        ...
        {
            Logger.LogDebug($"OnToggleChangedValue triggered. New value is {newValue.ToString()}");
        ...
        private void PerformDebugChecks()
        {
            ...
            {
                _dataOrbitalSurvey.SetVisible(_dataOrbitalSurvey.ScanningFieldOfViewDebug,
                    DebugUI.Instance.DebugFovEnabled);
        ...
        {
            Logger.LogDebug("OnFixedUpdate triggered.");
        }
        ...
        {
            Logger.LogDebug("Extend triggered.");
            return true;
        }
