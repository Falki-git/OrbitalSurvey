...
| `Assets/MyTest11/` | The **sample mod source** (template example) — kept for reference. |
| `Assets/Mods/__Testing/MyTest11/` | **Built output** of the sample mod, staged for the game. |
...
| `*.csproj`, `*.sln` | **Unity-generated** project files (git-ignored). Do not hand-edit; Unity regenerates them. |
...
- Asset bundles (`Copied/assets/bundles/`) were copied from the pre-Unity6 project and likely
  need to be rebuilt in the Unity 6 editor before they will load correctly at runtime.
