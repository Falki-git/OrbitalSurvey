...
public class WaypointController: MonoBehaviour
{
    ...
    private void OnAddWaypointClicked(ClickEvent _)
    {
        ...
        var control = new MapMarkerControl(SceneController.Instance.IsMarkerNamesVisible,
            SceneController.Instance.IsGeoCoordinatesVisible, MapMarkerControl.MarkerType.Waypoint, _waypointToAddColor)
        {
            NameValue = _waypointName.text,
            LatitudeValue = geographicCoordinates.latitude,
            LongitudeValue = geographicCoordinates.longitude
        };
