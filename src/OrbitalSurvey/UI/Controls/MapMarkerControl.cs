...
namespace OrbitalSurvey.UI.Controls
{
    public class MapMarkerControl: VisualElement
    {
        ...
        public MapMarkerControl(bool isNameVisible, bool isGeoCoordinatesVisible, MarkerType type, WaypointColor color)
            : this(isNameVisible, isGeoCoordinatesVisible, type)
        {
            switch (color)
            {
                case WaypointColor.Yellow: SetAsYellow(); 
                    break;
                case WaypointColor.Red: SetAsRed(); 
                    break;
                case WaypointColor.Green: SetAsGreen(); 
                    break;
                case WaypointColor.Blue: SetAsBlue(); 
                    break;
                case WaypointColor.Gray: SetAsGray(); 
                    break;
                default: SetAsYellow();
                    break;
            }
